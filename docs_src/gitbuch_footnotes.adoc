...
:fn19: pass:a,q[{wj}footnote:[Durch `git rm` löschen Sie eine Datei mit dem nächsten Commit; sie bleibt jedoch im Commit-Verlauf erhalten. Wie man eine Datei vollständig, also auch aus der Versionsgeschichte, löscht, ist in xref:gitbuch_08.adoc#sec.fb-censor[] nachzulesen.]]

:fn20: {wj}footnote:[Dieses und die folgenden Beispiele stammen aus dem Git-Repository.]

:fn21: pass:a,q[{wj}footnote:[ \
