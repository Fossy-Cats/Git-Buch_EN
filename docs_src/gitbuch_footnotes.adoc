...
////
:fn55: {wj}footnote:[ \
For example, by uploading the branch to a publicly available repository, see xref:gitbuch_05.adoc#sec.hochladen[].]
...
See also xref:gitbuch_05.adoc#sec.verteilte_systeme[].]]
