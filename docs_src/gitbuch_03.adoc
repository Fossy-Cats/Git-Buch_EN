...
image::commit.svg[id="fig.commit",scaledwidth="80%",width="80%"]
...
image::relative-refs.svg[id="fig.relative-refs",scaledwidth="65%",width="65%"]
...
// .Das Tag-Objekt
.The Tag Object
image::tags.svg[id="fig.tag-object",scaledwidth="90%",width="90%"]
...
image::merge-base-commit.svg[id="fig.merge-base-commit",scaledwidth="70%",width="70%"]
...
image::ff-before.svg[id="fig.merge-ff-before",scaledwidth="90%",width="90%"]
...
image::ff-after.svg[id="fig.merge-ff-after",scaledwidth="90%",width="90%"]
