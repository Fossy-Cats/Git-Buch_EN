...
`refs/` ::
All references, including branches in `refs/heads/`, see <<sec.branch-refs>>, tags in `refs/tags/`, see <<sec.tags>>, and remote tracking branches under `refs/remotes/`, see <<sec.remote_tracking_branches>>.
