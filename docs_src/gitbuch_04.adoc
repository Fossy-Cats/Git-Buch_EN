...
// .Vor dem Rebase
.Before the rebase
image::rebase-before.svg[id="fig.rebase-vorher-dia",scaledwidth="90%",width="90%"]

// .{empty}...und danach
.{empty}...and after that
image::rebase-after.svg[id="fig.rebase-nachher-dia",scaledwidth="90%",width="90%"]
...
image::rebase-onto-before.svg[id="fig.rebase-onto-vorher-dia",scaledwidth="90%",width="90%"]
...
image::rebase-onto-after.svg[id="fig.rebase-onto-nachher-dia",scaledwidth="90%",width="90%"]
