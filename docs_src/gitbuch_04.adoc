...
// .Vor dem Rebase
.Before the rebase
image::rebase-before.svg[id="fig.rebase-before",scaledwidth="90%",width="90%"]

// .{empty}...und danach
.{empty}...and after that
image::rebase-after.svg[id="fig.rebase-after",scaledwidth="90%",width="90%"]
...
image::rebase-onto-before.svg[id="fig.rebase-onto-before",scaledwidth="90%",width="90%"]
...
image::rebase-onto-after.svg[id="fig.rebase-onto-after",scaledwidth="90%",width="90%"]
