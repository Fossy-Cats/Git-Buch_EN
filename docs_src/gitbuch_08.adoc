...
[[sec.attributes]]
== Git Attributes -- Treating Files Separately
...
// @CHECK: Maybe "Configuring External Diff Tools"?
[[sec.diff-config]]
==== Configuring External Diffs
...
[[sec.for-each-ref]]
=== Iterating References: for-each-ref
...
[[sec.fb-censor]]
=== Removing Sensitive Information Afterwards
