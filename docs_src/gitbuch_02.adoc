...
.SHA-1 Algorithm
image::sha.svg[id="fig.sha-1",scaledwidth="90%",width="90%"]
...
.Git Objects
// .Git-Objekte
image::git-objects.svg[id="fig.git-objects",scaledwidth="90%",width="90%"]
...
image::git-objects-hierarchy.svg[id="fig.git-objects-hierarchy",scaledwidth="65%",width="65%"]
...
// .Ein Commit-Graph
.A Commit Graph
image::commit-graph.svg[id="fig.commit-graph",scaledwidth="45%",width="45%"]
...
image::commit-graph-with-refs.svg[id="fig.commit-graph-with-refs",scaledwidth="75%",width="75%"]
