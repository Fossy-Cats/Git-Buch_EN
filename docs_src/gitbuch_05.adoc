...
image::central-workflow.svg[id="fig.zentraler-workflow",scaledwidth="70%",width="70%"]
...
image::clone.svg[id="fig.clone",scaledwidth="100%",width="100%"]
...
image::fetch.svg[id="fig.fetch",scaledwidth="90%",width="90%"]
...
image::pull.svg[id="fig.pull",scaledwidth="90%",width="90%"]
...
image::pull-rebase.svg[id="fig.pull_rebase",scaledwidth="90%",width="90%"]
...
image::push.svg[id="fig.push",scaledwidth="100%",width="100%"]
...
image::integration-manager-workflow.svg[id="fig.developer-public-workflow",scaledwidth="70%",width="70%"]
...
image::patches-via-email.svg[id="fig.dictator",scaledwidth="90%",width="90%"]
