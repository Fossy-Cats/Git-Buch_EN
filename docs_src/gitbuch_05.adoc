...
To publish your work, i.e. upload it to a remote branch, you still need the `git push` command (<<sec.hochladen>>).
...
In <<fig.pull_rebase>> you can see what happens if you perform a rebase instead of the default merge.
